...
public abstract class AMessages implements Serializable {
     ...
     */
    protected static Map<String, List<String>> messages = new HashMap<>();
    ...
    public AMessages() {
        ...
        list.add("first message form static block for uuu-user");
        list.add("second message form static block for uuu-user");
        messages.put("uuu", list);
    }
